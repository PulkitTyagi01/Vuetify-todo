<template>
  <v-card ref="form" max-width="350" max-height="500" class="login-form">
    <div class="text-decoration-underline pt-1">
      <p class="text-center text--primary font-weight-bold text-h5">LOGIN</p>
    </div>
    <v-card-text>
      <v-text-field
        v-model="username"
    ...
    <v-card-actions>
      <v-btn class="btn-2" text @click="goToRegistration"> New User ? </v-btn>
      <v-spacer></v-spacer>
